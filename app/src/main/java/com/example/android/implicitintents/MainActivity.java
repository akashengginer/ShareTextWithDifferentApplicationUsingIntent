...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String texttoShare = "Hello there , this message can be shared through different application on the device";
    ...
    /*Using this function user can choose by which application to share the message or any data
    * */
